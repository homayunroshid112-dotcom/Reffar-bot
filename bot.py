...
# Environment variables থেকে BOT_TOKEN & ADMIN_ID নেওয়া
TOKEN = os.getenv("8431168965:AAH0SKTvjwoKRtO_7UlAtfwb8R66gSHDZRY")
ADMIN_ID = int(os.getenv("ADMIN_ID", "8287786713"))
